...
const Banner = () => {
  ...
  return (
    <div className="carousel w-full">
      <div
        className="hero min-h-screen banner carousel-item w-full"
        style={{
          backgroundImage:
            "url(https://i.ibb.co/M7cc62w/real-estate-banner.jpg)",
        }}
      >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://i.ibb.co/B3fcSHr/banner-bg-2.jpg)",
        }}
      >
        <div className="hero-overlay bg-opacity-50"></div>
        <div className="hero-content text-center text-neutral-content">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://i.ibb.co/QJhsQB4/banner-bg-3.jpg)",
        }}
      >
        <div className="hero-overlay bg-opacity-50"></div>
        <div className="hero-content text-center text-neutral-content">
